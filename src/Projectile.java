...
public class Projectile {
	...
	void spawn(Tower t,float speed,int damage, int width, int height, BufferedImage texture, boolean explosive, int explosionRange, boolean spawnsPuddle, float slowPerc) {
		setSpawned(true);
