			...
			public void run() {
				...
				if(Game.wHandler.isWaveOn() == true) {
					...
					Game.wHandler.setWaveLength(Game.wHandler.getWaveLength() - 1);
						...
						Game.wHandler.setWaveLength(20000);
				...
				//Regelt das Verhalten der TŸrme
				for(int i = 0; i < 100; i++) {
