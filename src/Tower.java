...
public abstract class Tower {
	...
	static void handleMenu(Tower e[]) {
	...
	void shoot(Tower t,float speed,int damage, int width, int height, BufferedImage texture, boolean explosive, int explosionRange, boolean puddle, float slowPerc) {
	...
	static void handleSpawns(Tower e[]) {
